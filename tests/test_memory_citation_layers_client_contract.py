...
class MemoryCitationLayersClientContractTests(unittest.TestCase):
    ...
    def test_cache_versions_are_bumped_for_citation_sync_assets(self):
        ...
        self.assertIn("/static/js/runtime/runtime-memory-view.js?v=delayed-fact-link-1", source)
        self.assertIn("/static/js/runtime/runtime-avatar.js?v=runtime-change-markers-24", source)
        self.assertIn("/static/js/think-citations.js?v=think-citations-6", source)
        self.assertIn("/static/js/chat.js?v=deep-search-marker-strip-2", source)
