...
class MemoryCitationLayersClientContractTests(unittest.TestCase):
    ...
    def test_cache_versions_are_bumped_for_citation_sync_assets(self):
        ...
        self.assertIn("/static/js/runtime/runtime-memory-view.js?v=runtime-memory-view-18", source)
        self.assertIn("/static/js/runtime/runtime-avatar.js?v=memory-rings-11", source)
        self.assertIn("/static/js/think-citations.js?v=think-citations-4", source)
