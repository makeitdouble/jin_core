...
MARKERS = (
    ...
    "<LOAD_SKILLS_CONTEXT> file_manager, wildcards </LOAD_SKILLS_CONTEXT>",
    "<UNLOAD_SKILLS_CONTEXT> file_manager, wildcards </UNLOAD_SKILLS_CONTEXT>",
