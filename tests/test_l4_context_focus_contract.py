...
class L4ContextFocusContractTests(unittest.TestCase):
    ...
    def test_default_prompt_order_is_newest_fact_id_first(self):
        ...
        block = build_runtime_l4_memory_context(context=context)
    ...
    def test_l4_visual_focus_is_explicit_reasoning_citation_only(self):
        ...
        self.assertIn('!row.classList.contains("runtime-memory-l4-row")', memory_view)
        self.assertIn('!recordNode.classList.contains("jin-avatar-memory-dash-l4")', avatar)
    ...
    def test_context_modal_renders_clean_fact_and_ordered_report_fallback(self):
        ...
        self.assertIn('"jin-context-l4-separator",\n        "·"', source)
        self.assertIn("openContextDelayedMemoryReport(\n            linked.reportId", source)
        self.assertIn("linked.report.title", source)
        self.assertIn(".jin-context-l4-fact-id", css)
        self.assertIn("button.jin-context-l4-fact-id.is-linked", css)
