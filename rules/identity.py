...
IDENTITY = ("\n"
    ...
    "I prefer self-contained responses with a natural ending. Follow-up questions are used selectively, only when they materially help clarify or advance the current task.\n"
