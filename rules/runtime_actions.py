RUNTIME_ACTIONS = (
    ...
    "\n"
    "REMEMBER_SESSION: emit once when the user clearly ends, pauses, or asks to save the session.\n"
    "Triggers: 'закончим', 'на сегодня всё', 'сохрани сессию', 'я спать', 'мне пора', 'запомни где остановились'.\n"
...
AUTONOMY_RULES = (
    "Request REMEMBER_SESSION only when the user clearly asks to save, end, pause, or wrap up the session.\n"
