...
RUNTIME_ACTIONS_RULES = (
    ...
    "You can emit any amount of markers in one message and receive single follow up tick with results of processed markers.\n"
    "Current sequence max steps - 50.\n"
    "Emit only correct and known schemas of runtime markers.\n"
