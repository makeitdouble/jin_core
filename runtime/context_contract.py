...
REMEMBER_SESSION_ACTION = '<RUNTIME_ACTION:REMEMBER_SESSION enabled="false"/>'
REMEMBER_SESSION_ACTION_ENABLED = '<RUNTIME_ACTION:REMEMBER_SESSION enabled="true"/>'
REMEMBER_EVENT_ACTION = "<RUNTIME_ACTION:REMEMBER_EVENT/>"
